...
export type ResultViewModel = {
  ...
  characterImageSrcSet: string | null;
  characterImageSizes: string | null;
  characterImageDownloadSrc: string | null;
  characterImageDownloadFilename: string | null;
...
export function createResultViewModel(
  ...
  return {
    ...
    characterImageSrcSet: characterAsset.srcSet,
    characterImageSizes: characterAsset.sizes,
    characterImageDownloadSrc: characterAsset.downloadSrc,
    characterImageDownloadFilename: characterAsset.downloadFilename,
